(function ($) {
  ...
  var GaviasTheme = {
    ...
    initCarousel: function () {
      ...
      $(".init-carousel-swiper-theme").each(function () {
        ...
        var swiper = new Swiper($target[0], {
          ...
          breakpoints: {
            0: { slidesPerView: 1 },
            390: { slidesPerView: settings.items_xx },
    ...
    menuMobile: function () {
      ...
      $(document).on(
        "click",
        ".canvas-menu.gva-offcanvas > a.dropdown-toggle",
        function (e) {
          e.preventDefault();
      ...
      $(document).on(
        "click",
        "#gva-overlay, .top-canvas a.control-close-mm",
        function (e) {
          e.preventDefault();
    ...
    other: function () {
      ...
      $(".constix-post-share.style-2 .btn-control-share").on(
        "click",
        function (e) {
          e.preventDefault();
  ...
  $(window).on("load", function () {
    ...
    if ($(".product-single-inner .flex-control-nav").length) {
      $(".product-single-inner .flex-control-nav").wrap(
        '<div class="swiper-container product-thumbnail-swiper"></div>'
      );
      $(".product-single-inner .flex-control-nav").after(
        '<div class="swiper-nav-next"></div><div class="swiper-nav-prev"></div>'
      );
      $(".product-single-inner .flex-control-nav").addClass("swiper-wrapper");
      $(".product-single-inner .flex-control-nav > li").addClass(
        "swiper-slide"
      );
      var swiper = new Swiper(
        ".product-single-inner .product-thumbnail-swiper",
        {
